...
psfCW = responseAngSpecCW(x, z, elemSpace, apod', steerAng, focDepth, f(f_idx), c);
...
psf_t = responseAngSpecPW(x, z, elemSpace, apod_P_f, steerAng, focDepth, f, c, t);
...
psf = responseAngSpec2WayPW(x, z, elemSpace, apod_tx, txSteerAng, ...
    txFocDepth, apod_rx, rxSteerAng, rxFocDepth, f, c);
